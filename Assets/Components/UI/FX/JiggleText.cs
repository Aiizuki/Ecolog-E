...
public class JiggleText : MonoBehaviour
{
	...
	[SerializeField] private float _amplitude = 40f;        // hauteur du rebond (px)
	[SerializeField] private float _duration = 0.6f;        // durée par lettre (s)
	[SerializeField] private float _staggerDelay = 0.04f;   // délai entre chaque lettre (s)
	[SerializeField] private float _maxRotation = 12f;      // rotation max (°)
